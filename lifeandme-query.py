...
def query(question, chat_history):
    ...
    llm = ChatOpenAI(model_name = 'gpt-4o', temperature=0,  base_url="https://api.avalai.ir/v1", api_key="aa-83NkaoDGyrW6YntO09P9kr9veMZlNBs2xblWf1hdB8OpPs3N") 
    ...
    system_prompt = (
        ...
        "You should support both english and persian languages"
